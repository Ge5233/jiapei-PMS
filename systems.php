        ...
        <template x-for="(mod,mi) in modules" :key="mi">
            <div class="mb-3 border rounded">
                ...
                <div x-show="mod._open!==false">
                    ...
                    <!-- 列头 -->
                    <div class="grid grid-cols-[56px_200px_1fr_56px_72px_96px_100px_80px] items-center gap-1 px-3 py-1.5 text-xs text-slate-400 border-b border-slate-100"
                    ...
                    <template x-for="(it,ii) in (mod.items||[])" :key="ii">
                        <div class="border-b border-slate-100">
                            <!-- 主材行 -->
                            <div class="grid grid-cols-[56px_200px_1fr_56px_72px_96px_100px_80px] items-center gap-1 px-3 py-2 text-sm bg-sky-100 border-t border-sky-300">
                            ...
                            <template x-if="(it.subs||[]).length>0">
                                <div class="bg-white" x-show="!it._collapsed">
                                    <template x-for="(s,si) in (it.subs||[])" :key="si">
                                        <div class="grid grid-cols-[56px_200px_1fr_56px_72px_96px_100px_80px] items-center gap-1 px-3 py-1 text-xs border-b border-slate-100">
